...
2. `load`: The load command will load the inverted index and the document map stored on the disk, into the application memory, to allow search. Example usage is just the command with no additional arguments: `load`.
...
4. [validators](https://github.com/python-validators/validators): To validate a URL.
5. [nltk](https://github.com/nltk/nltk): For tokenisation capabilities.
6. [pytest](https://github.com/pytest-dev/pytest): To write tests.
7. [pytest-cov](https://github.com/pytest-dev/pytest-cov): To get the percentage coverage of code by the tests.
